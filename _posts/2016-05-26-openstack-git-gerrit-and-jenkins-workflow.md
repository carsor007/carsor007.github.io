...
![GerritGitJenkinsWorkflow.png]({{site.baseurl}}/imgs/GerritGitJenkinsWorkflow.png)
<meta content="http://carsor007.github.com//_posts/GerritGitJenkinsWorkflow.png" property="og:image">
...
![setup.png]({{site.baseurl}}/imgs/setup.png)
...
- Make sure you have the latest upstream changes by running the following commands
 ...
 ![git-pull.png]({{site.baseurl}}/imgs/git-pull.png)
...
![topic-branch.png]({{site.baseurl}}/imgs/topic-branch.png)
...
![mvn.png]({{site.baseurl}}/imgs/mvn.png)
