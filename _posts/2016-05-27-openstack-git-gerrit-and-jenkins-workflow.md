...
![GerritGitJenkinsWorkflow.png]({{site.url}}/imgs/GerritGitJenkinsWorkflow.png)
...
![setup.png]({{site.url}}/imgs/setup.png)
...
- Make sure you have the latest upstream changes by running the following commands
 ...
 ![git-pull.png]({{site.url}}/imgs/git-pull.png)
...
![topic-branch.png]({{site.url}}/imgs/topic-branch.png)
